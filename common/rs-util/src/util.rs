...
pub type __blklibc= libc::c_long;
pub type __blkcnt_t = libc::c_long;
pub type __slibc = libc::c_long;
...
pub type libc_long = libc::c_long;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct timeval {
    pub tv_sec: __time_t,
...
//     pub ctl: *mut ctl,
//     pub skipped_ctl_calls: ulibc::c_long,
// }
// pub type ulibc::c_long = __ulibc::c_long;
...
pub struct stat {
    ...
    pub st_rdev: __dev_t,
    pub st_size: __off_t,
    pub st_blksize: __blklibc::c_ulong,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_mutex_lock(mut m: *mut pthread_mutex_t) { unsafe {
    let mut rc = pthread_mutex_lock(m);
    if rc != 0 {
        abort();
    }
}}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_mutex_unlock(mut m: *mut pthread_mutex_t) { unsafe {
    let mut rc = pthread_mutex_unlock(m);
    if rc != 0 {
        abort();
    }
}}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_gettid() -> pid_t { unsafe {
    syscall(186 as libc::c_int as libc::c_long) as pid_t
}}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_malloc(mut size: libc::c_ulong) -> *mut libc::c_void { unsafe {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_calloc(mut size: libc::c_ulong) -> *mut libc::c_void { unsafe {
    let mut ptr: *mut libc::c_void = ut_malloc(size);
    memset(ptr, 0 as libc::c_int, size);
    ptr
}}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_strdup(mut str: *const libc::c_char) -> *mut libc::c_char { unsafe {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_free(mut ptr: *mut libc::c_void) { unsafe {
    free(ptr);
}}
#[unsafe(no_mangle)]
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_close(mut fd: libc::c_int) { unsafe {
    let mut _errno: libc::c_int = *__errno_location();
    close(fd);
    *__errno_location() = _errno;
}}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_close_if_valid(mut fd: libc::c_int) { unsafe {
    if fd >= 0 as libc::c_int {
        ut_close(fd);
    }
}}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_timeval_to_f(mut tv: *const timeval) -> libc::c_double { unsafe {
    (*tv).tv_sec as libc::c_double + (*tv).tv_usec as libc::c_double / 1e6f64
}}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_timespec_to_f(mut ts: *const timespec) -> libc::c_double { unsafe {
    (*ts).tv_sec as libc::c_double + (*ts).tv_nsec as libc::c_double / 1e9f64
}}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_f_to_timespec(mut t: libc::c_double, mut ts: *mut timespec) { unsafe {
...
pub unsafe extern "C" fn ut_send_all(
    ...
    let mut offset: slibc::c_ulong = 0 as libc::c_int as slibc::c_ulong;
    loop {
        let mut bytes_written: slibc::c_ulong = send(
            fd,
            buf.offset(offset as isize),
            count.wrapping_sub(offset as libc::c_ulong),
            flags,
        );
        if bytes_written < 0 as libc::c_int as slibc::c_ulong {
...
pub unsafe extern "C" fn ut_vaprintf(
    ...
    let mut len: libc::c_ulong = strlen(buf);
    let mut used: libc::c_ulong = len.wrapping_add(1 as libc::c_int as libc::c_ulong);
    if used > capacity {
        abort();
    }
    let mut left: libc::c_ulong = capacity.wrapping_sub(used);
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_is_blocking(mut fd: libc::c_int) -> bool { unsafe {
    let mut flags: libc::c_int = fcntl(fd, 3 as libc::c_int, 0 as libc::c_int);
...
unsafe extern "C" fn socket_error(mut fd: libc::c_int) -> libc::c_int { unsafe {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_established(mut fd: libc::c_int) -> libc::c_int { unsafe {
    let mut pfd: pollfd = {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_is_readable(mut fd: libc::c_int) -> bool { unsafe {
    let mut pfd: pollfd = {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_self_net_ns(mut name: *mut libc::c_char) -> libc::c_int { unsafe {
    ...
    *__errno_location() = 0 as libc::c_int;
    let mut e: *mut dirent = std::ptr::null_mut::<dirent>();
    loop {
        e = readdir(ns_dir);
        if e.is_null() {
...
unsafe extern "C" fn load_file(
    ...
    mut spare_capacity: libc::c_ulong,
) -> slibc::c_ulong { unsafe {
    let mut current_block: u64;
    let mut capacity: libc::c_ulong = 0 as libc::c_int as libc::c_ulong;
    let mut len: slibc::c_ulong = 0 as libc::c_int as slibc::c_ulong;
        ...
        *data = std::ptr::null_mut::<libc::c_char>();
        loop {
            ...
            *data = ut_realloc(
            ...
            let mut b: libc::c_ulong = fread(
                (*data).offset(len as isize) as *mut libc::c_void,
                1 as libc::c_int as libc::c_ulong,
                256 as libc::c_int as libc::c_ulong,
                f,
            );
            len = (len as libc::c_ulong).wrapping_add(b) as slibc::c_ulong as slibc::c_ulong;
            if b >= 256 as libc::c_int as libc::c_ulong {
                continue;
            }
            if ferror(f) != 0 {
    ...
    -(1 as libc::c_int) as slibc::c_ulong
}}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_load_file(
    ...
    load_file(filename, data, 0 as libc::c_int as libc::c_ulong)
}}
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_load_text_file(
    ...
    let mut rc: slibc::c_ulong = load_file(filename, data, 1 as libc::c_int as libc::c_ulong);
    if rc >= 0 as libc::c_int as slibc::c_ulong {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_die(mut fmt: *const libc::c_char, mut args: ...) -> ! { unsafe {
    let mut ap: ::core::ffi::VaListImpl;
    ap = args.clone();
