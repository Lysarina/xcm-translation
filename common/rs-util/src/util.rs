// Generated by c2rust. In a few functions, calls to __log... were inserted and these casued link-time errors. These were inserted because of the macro ut_assert in the c file.
#![allow(
    dead_code,
    mutable_transmutes,
...
pub unsafe extern "C" fn ut_mutex_init(mut m: *mut pthread_mutex_t) {
    ...
    if !(rc == 0 as libc::c_int) {
        ...
        if log_is_enabled(log_type_error) {
            __log_event(
                log_type_error,
                b"/home/lysarina/skool/exjobb/xcm-translation/common/util.c\0"
    ...
    if !(used <= capacity) {
        ...
        if log_is_enabled(log_type_error) {
            __log_event(
                ...
                0 as *mut xcm_socket,
                b"Assertion \"%s\" failed.\n\0" as *const u8 as *const libc::c_char,
                b"used <= capacity\0" as *const u8 as *const libc::c_char,
            );
        }
        abort();
    }
...
//Refactored, attempted to make more idiomatic rust code
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ut_mutex_init(m: *mut pthread_mutex_t) {
