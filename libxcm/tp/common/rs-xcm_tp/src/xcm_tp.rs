...
//         0 => b"connection\0".as_ptr() as *const libc::c_char,
//         1 => b"server\0".as_ptr() as *const libc::c_char,
...
// #[unsafe(no_mangle)]
// pub unsafe extern "C" fn xcm_tp_socket_destroy(mut s: *mut xcm_socket) { unsafe {
...
// }}
// unsafe extern "C" fn do_ctl(mut s: *mut xcm_socket) { unsafe {
//     if !((*s).ctl).is_null() {
//         ctl_process((*s).ctl);
//     }
// }}
...
//     }
// }}
// unsafe extern "C" fn consider_auto_update(mut s: *mut xcm_socket) { unsafe {
//     if (*s).auto_update {
//         xcm_tp_socket_update(s);
//     }
// }}
// unsafe extern "C" fn consider_auto_enable_ctl(mut s: *mut xcm_socket) { unsafe {
...
// }}
// #[unsafe(no_mangle)]
// pub unsafe extern "C" fn xcm_tp_socket_close(mut s: *mut xcm_socket) { unsafe {
//     if !s.is_null() {
...
// }}
// #[unsafe(no_mangle)]
// pub unsafe extern "C" fn xcm_tp_socket_cleanup(mut s: *mut xcm_socket) { unsafe {
//     if !s.is_null() {
...
// }}
// #[unsafe(no_mangle)]
// pub unsafe extern "C" fn xcm_tp_socket_update(mut s: *mut xcm_socket) { unsafe {
...
// }}
// #[unsafe(no_mangle)]
// pub unsafe extern "C" fn xcm_tp_socket_max_msg(mut conn_s: *mut xcm_socket) -> size_t { unsafe {
...
//     ::core::mem::size_of::<int64_t>() as libc::c_ulong as libc::c_int
// }}
// unsafe extern "C" fn populate_common(mut s: *mut xcm_socket, mut tree: *mut attr_tree) { unsafe {
...
//     );
// }}
// unsafe extern "C" fn populate_msg_cnt(mut s: *mut xcm_socket, mut tree: *mut attr_tree) { unsafe {
//     attr_tree_add_value_node(
//         tree,
...
// }}
// unsafe extern "C" fn populate_server(mut s: *mut xcm_socket, mut tree: *mut attr_tree) { unsafe {
//     populate_common(s, tree);
//     attr_tree_add_value_node(
//         tree,
//         b"xcm.local_addr\0" as *const u8 as *const libc::c_char,
        ...
        _ => {
            if 0 as libc::c_int == 0 {
                ...
                if log_is_enabled(log_type_error) {
                    __log_event(
                        log_type_error,
                        b"/home/lysarina/skool/exjobb/xcm-translation/libxcm/tp/common/xcm_tp.c\0"
                            as *const u8 as *const libc::c_char,
                        25 as libc::c_int,
                        (*::core::mem::transmute::<
                            &[u8; 24],
...
unsafe extern "C" fn consider_ctl(
    ...
    if temporarly_failed_op {
        (*s)
            .skipped_ctl_calls = ((*s).skipped_ctl_calls as libc::c_ulong)
