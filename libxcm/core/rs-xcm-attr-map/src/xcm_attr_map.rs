...
use rs_log::*;
use rs_util::*;
use xcm_rust_common::cyclic_declarations::ctl;
...
extern "C" {
    // pub type ctl; //cyclic_declarations
    // pub type xpoll; //xcm_rust_common::xcm_tp_mod::xpoll
    // pub type attr_tree; //xcm_rust_common::attr_tree_mod::attr_tree
    fn abort() -> !;
    fn memcmp(
        _: *const libc::c_void,
        _: *const libc::c_void,
...
>;
unsafe extern "C" fn assert_valid_len(mut type_0: xcm_attr_type, mut value_len: libc::c_ulong) {
...
unsafe extern "C" fn copy_attr_cb(
    ...
    mut attr_value_len: libc::c_ulong,
...
pub unsafe extern "C" fn xcm_attr_map_get(
    ...
    mut attr_value_len: *mut libc::c_ulong,
) -> *const libc::c_void {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn xcm_attr_map_size(mut attr_map: *const xcm_attr_map) -> libc::c_ulong {
...
pub unsafe extern "C" fn xcm_attr_map_equal(
    ...
    let mut size_a: libc::c_ulong = xcm_attr_map_size(attr_map_a);
    let mut size_b: libc::c_ulong = xcm_attr_map_size(attr_map_b);
    if size_a != size_b {
